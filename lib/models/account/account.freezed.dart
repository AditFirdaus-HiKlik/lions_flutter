...
class _$_Account with DiagnosticableTreeMixin implements _Account {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Account(id: $id, memberID: $memberID, username: $username, email: $email, confirmed: $confirmed, blocked: $blocked, avatar: $avatar, name: $name, about: $about, address: $address, rank: $rank, phone: $phone, district: $district, club: $club, awards: $awards, achivements: $achivements, social: $social, trainings: $trainings)';
  }
